...
const FaqItem = [
  {
    ...
    desc: "Join our Discord community and follow our other social channels. You can also MyntistGPT as a personal AI generated guide to the ecosystem.",
  },
  {
    id: "1",
  ...
  },
  {
    ...
    desc: "We will have our token launch towards the end of Q4 2023. Our staking website will have full guidance on how to purchase our token and we will also release a trailer of which exchanges we will be listed on closer to the time.",
  },
  {
    id: "3",
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="faq-title text-center">
              <div className="h5" data-aos="fade-up" data-aos-duration="1000">
                MYNTIST FAQ
              </div>
              <div className="h2" data-aos="fade-up" data-aos-duration="1200">
